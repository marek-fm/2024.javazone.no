import { M as Mime_1, s as standard, g as getDefaultExportFromCjs } from './chunks/pages/generic_8ab974b8.mjs';
import { A as AstroError, p as ResponseSentError, u as MiddlewareNoDataOrNextCalled, v as MiddlewareNotAResponse, G as GetStaticPathsRequired, w as InvalidGetStaticPathsReturn, x as InvalidGetStaticPathsEntry, y as GetStaticPathsExpectedParams, z as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, B as GetStaticPathsRemovedRSSHelper, N as NoMatchingStaticPathFound, D as PrerenderDynamicEndpointPathCollide, F as LocalsNotAnObject, H as ASTRO_VERSION, C as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, J as renderEndpoint } from './chunks/astro_52b6238d.mjs';
import { t as trimSlashes } from './chunks/astro/assets-service_b4bb34ad.mjs';
...
async function callEndpoint(mod, env, ctx, onRequest, locales) {
  ...
  const mimeType = mime$1.getType(pathname) || "text/plain";
...
const manifest = deserializeManifest({"adapterName":"@astrojs/vercel/serverless","routes":[{"file":"index.html","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"_meta":{"trailingSlash":"ignore"}}},{"file":"partner/index.html","links":[],"scripts":[],"styles":[],"routeData":{"route":"/partner","type":"page","pattern":"^\\/partner\\/?$","segments":[[{"content":"partner","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/partner/index.astro","pathname":"/partner","prerender":true,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"endpoint","route":"/_image","pattern":"^\\/_image$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"params":[],"component":"node_modules/.pnpm/astro@3.5.4_typescript@5.2.2/node_modules/astro/dist/assets/endpoint/generic.js","pathname":"/_image","prerender":false,"_meta":{"trailingSlash":"ignore"}}}],"base":"/","trailingSlash":"ignore","compressHTML":true,"componentMetadata":[["/Users/tanettrimas/dev/javabin/2024.javazone.no/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/Users/tanettrimas/dev/javabin/2024.javazone.no/src/pages/partner/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var i=t=>{let e=async()=>{await(await t())()};\"requestIdleCallback\"in window?window.requestIdleCallback(e):setTimeout(e,200)};(self.Astro||(self.Astro={})).idle=i;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var s=(i,t)=>{let a=async()=>{await(await i())()};if(t.value){let e=matchMedia(t.value);e.matches?a():e.addEventListener(\"change\",a,{once:!0})}};(self.Astro||(self.Astro={})).media=s;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var r=(i,c,s)=>{let n=async()=>{await(await i())()},t=new IntersectionObserver(e=>{for(let o of e)if(o.isIntersecting){t.disconnect(),n();break}});for(let e of s.children)t.observe(e)};(self.Astro||(self.Astro={})).visible=r;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000@astrojs-ssr-virtual-entry":"entry.mjs","\u0000@astro-renderers":"renderers.mjs","\u0000empty-middleware":"_empty-middleware.mjs","\u0000@astrojs-manifest":"manifest_13fe737d.mjs","\u0000@astro-page:node_modules/.pnpm/astro@3.5.4_typescript@5.2.2/node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_b4bd0076.mjs","\u0000@astro-page:src/pages/index@_@astro":"chunks/index_61491ca0.mjs","\u0000@astro-page:src/pages/partner/index@_@astro":"chunks/index_8463f766.mjs","astro:scripts/before-hydration.js":""},"assets":["/_astro/main-area.fd8fc680.jpg","/images/concept-stand.png","/images/restaurant-stand.png","/images/standard-stand.png","/index.html","/partner/index.html"]});

export { AstroCookies as A, Logger as L, RouteCache as R, dateTimeFormat as a, bold as b, cyan as c, dim as d, reset as e, computePreferredLocale as f, computePreferredLocaleList as g, routeIsRedirect as h, redirectRouteStatus as i, redirectRouteGenerate as j, routeIsFallback as k, levels as l, attachCookiesToResponse as m, manifest, createAPIContext as n, callEndpoint as o, callMiddleware as p, AstroIntegrationLogger as q, red as r, getSetCookiesFromResponse as s, createRenderContext as t, yellow as y };
